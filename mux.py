...
class Mux():
    ...
    name = "Mux4x1"
    inputs = [Input("inp0", Std_logic())] 
    inputs = [Input("inp1", Std_logic())] #inp00 ="0001"
    inputs = [Input("inp2", Std_logic())] #inp00 ="0001"
    inputs = [Input("inp3", Std_logic())] #inp00 ="0001"
    inputs = [Input("select", Std_logic_vector(2))] #S = '01'
